      ...
      <div className="space-y-2 md:space-y-3">
        ...
        <div className="relative">
          <Input
            ref={ref}
            className={cn(
              "h-12 md:h-14 text-base font-medium border-2 border-border rounded-lg bg-background focus:bg-white focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200 shadow-sm hover:shadow-md",
          ...
          {unit && (
            <div className="absolute inset-y-0 right-0 flex items-center pr-3">
              <span className="text-sm font-semibold text-muted-foreground bg-muted px-2 py-1 rounded-md border border-border/50">
                {unit}
              </span>
            </div>
          )}
